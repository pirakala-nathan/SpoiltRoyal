class Attachment < ActiveRecord::Base
  ...
  has_attached_file :image, :styles => {:post_media => "225x150#",:vendor_cover => "970x385#",:vendor_media =>"120x120#", :medium => "300x300>", :thumb => "100x100>",:profile => "200x200>",:small => "70X70#", :full => "1000X670>", :index => "180X191#" }  
